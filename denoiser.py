...
noisy_image_path = st.text_input("Enter the full path of the noisy image on your local drive:")

# Load and preprocess the noisy image
noisy_img = image.load_img(noisy_image_path, target_size=(256, 256))
